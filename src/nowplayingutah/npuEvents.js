...
exports.updateNpuEvents = async function (hcmsToken) {
  const res = await axios.get("https://www.nowplayingutah.com/api/v1/syndication/events/?limit=30&output=json&token=F5nhq8MoWtt2MXe6GDPAoumYQY0SqQ6vWWDdhAJb_253149", {
    headers: {
  ...
  for (var i = 0; i < json.data.length; i++) {
    // Below we check to see if the event zipcode matches Sandy City to filter out events
    if (
